...
private String nombres[]={"caraemocionado.jpg","caraenfermo.jpg","carafeliz.jpg","caragolpeado.jpg","desconcertado.jpg"};
private int turno;
     ...
     if(obj instanceof JButton){
      ...
      if(btn==desconcertado)
		...
		bodyo.changeTextureCab(texture, nombres[b]);
     	r.escribeRed(new Icono("Tamagochi", turno, nombres[b]));
     }
  }
}
